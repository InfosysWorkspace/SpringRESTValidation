...
public class CustomerAPI {
    ...
    public ResponseEntity<CustomerDTO> getCustomersDetails(@PathVariable Integer customerId) throws Exception{
    ...
    public ResponseEntity<String> uodateCustomer(@PathVariable Integer customerId, @RequestBody CustomerDTO customer) throws Exception{
